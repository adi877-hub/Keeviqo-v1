...
echo "🚀 Starting Keeviqo Enhanced JavaScript Server with Localtunnel..."
...
echo "Starting enhanced JavaScript server..."
node enhanced-js-server.js &
SERVER_PID=$!
...
lt --port 3002 --subdomain keeviqo-platform-premium &
TUNNEL_PID=$!

echo "Waiting for tunnel to start..."
sleep 5

echo "✅ Your Keeviqo platform is available at: https://keeviqo-platform-premium.loca.lt"
