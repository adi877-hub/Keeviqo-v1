...
echo "🚀 Starting Keeviqo JavaScript Server with Localtunnel..."
...
echo "✅ Your Keeviqo platform is available at: https://keeviqo-platform.loca.lt"
